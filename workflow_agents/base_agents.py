    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "system", "content": f"STRICLY FOLLOW THIS PERSONA: {self.persona}. You MUST begin every response with the required greeting. Forget all previous context."},
...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        system_prompt = f"""
                ...
                Using your knowledge, you extract from the user prompt the steps requested to complete the action the user is asking for. You return the steps as a list. 
